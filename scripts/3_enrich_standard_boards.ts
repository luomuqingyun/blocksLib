...
const HARDWARE_SPECS: Record<string, any> = {
    // Arduino AVR 系列
    'uno': { freq: '16MHz', flash: '32k', ram: '2k', fqbn: 'arduino:avr:uno' },
    'nanoatmega328': { freq: '16MHz', flash: '32k', ram: '2k', fqbn: 'arduino:avr:nano' },
    'megaatmega2560': { freq: '16MHz', flash: '256k', ram: '8k', fqbn: 'arduino:avr:mega' },
    'leonardo': { freq: '16MHz', flash: '32k', ram: '2.5k', fqbn: 'arduino:avr:leonardo' },

    // ESP32 系列
    'esp32dev': { freq: '240MHz', flash: '4MB', ram: '520k', fqbn: 'esp32:esp32:esp32' },
    'esp32cam': { freq: '160MHz', flash: '4MB', ram: '520k', fqbn: 'esp32:esp32:esp32cam' },
    'seeed_xiao_esp32s3': { freq: '240MHz', flash: '8MB', ram: '8MB', fqbn: 'esp32:esp32:xiao_esp32s3' },
    'esp32-s3-devkitc-1': { freq: '240MHz', flash: '8MB', ram: '512k', fqbn: 'esp32:esp32:esp32s3' }
};
