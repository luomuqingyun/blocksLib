...
| **S5** | `core/4_generate_stm32_data.ts` | `scripts/generated/detailed_board_data.json`<br/>`scripts/generated/stm32_layouts_cache.json`<br/>`scripts/generated/stm32duino_support_registry.json` | `src/data/boards/stm32/**/*.json`<br/>`electron/config/stm32_compatibility_enhanced.json`<br/>`electron/config/unsupported_8kb_chips.json`<br/>`docs/unsupported_8kb_chips.md` | 合并所有数据，生成最终的文件及兼容性映射。同时自动拦截并生成 8KB 低配版芯片的黑名单报告。 |
