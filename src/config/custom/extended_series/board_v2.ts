...
export const MY_BOARD_V2: Board = {
    id: 'my_board_v2',
    name: { zh: '我的开发板 V2 (增强版)', en: 'My Board V2 (Pro)' },
    ...
    pins: {
        ...
        pwm: [{ label: { zh: '任何引脚', en: 'Any GPIO' }, value: 'any' }],
        i2c: [{ label: 'SDA (8)', value: '8' }, { label: 'SCL (9)', value: '9' }],
        spi: [{ label: 'MOSI (11)', value: '11' }, { label: 'MISO (13)', value: '13' }, { label: 'SCK (12)', value: '12' }],
        serial: [{ label: { zh: '默认串口', en: 'Serial0' }, value: 'Serial0' }, { label: { zh: 'USB 串口', en: 'USB Serial' }, value: 'Serial' }]
    },
